"""
Django settings for candle_store_43903 project.
...
ROOT_URLCONF = 'candle_store_43903.urls'
...
WSGI_APPLICATION = 'candle_store_43903.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "candle_store_43903 API",
    "DESCRIPTION": "API documentation for candle_store_43903 App",
    "VERSION": "v1",
}
